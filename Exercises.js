...
const Exercises = ({ exercises=[], setExercises, bodyPart }) => {
  ...
  useEffect(() => {
    const fetchExercisesData = async () => {
      let exercisesData = [];
      console.log('Fetching data for bodyPart:', bodyPart);
  ...
  console.log('Index of First Exercise:', indexOfFirstExercise);
  console.log('Index of Last Exercise:', indexOfLastExercise);
